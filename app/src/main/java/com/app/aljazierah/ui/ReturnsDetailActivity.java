...
public class ReturnsDetailActivity extends AppCompatActivity {
    private ImageView  imageViewBack;
    private TextView tvComplaintNo,tvComplaintId, tvWarrenty, tvCity,
            tvFull_Name, tvproduct_type,tvIssue,tvInvoice_number,
            tvInvoice_date,tvMobile_Number,tvemail,tvRegion,tvTitle,tvProblem_Description,tvToolbarTitleTCA,
            textview_location, tvServiceSlot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            tvServiceSlot.setText(getResources().getString(R.string._string_service_slot)+": "+jsonObject1.optString("service_slot"));
            ...
            tvInvoice_date.setText(getResources().getString(R.string.invoice_date)+": "+jsonObject1.optString("purchase_date"));
