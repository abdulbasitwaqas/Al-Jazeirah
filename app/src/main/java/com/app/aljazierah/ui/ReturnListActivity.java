...
public class ReturnListActivity extends AppCompatActivity {
    ...
    private List<MaintenencesData> maintenencesData = new ArrayList<>();
    ...
    private void initMembers() {
        ...
        getAftersalesReturnData();
        tvToolbarTitleTCA.setText(getResources().getString(R.string._string_my_returns));

    }


    private void getAftersalesReturnData() {
        showProgress(true);
        ...
        APIManager.getInstance().getReturnDataRequest(new APIManager.Callback() {
            @Override
            public void onResult(boolean z, String response) {
                ...
                if (z) {
                    ...
                    try {
                        ...
                        showRoomsAdapter = new AfterSaleseReturnDataAdapter(maintenencesData, ReturnListActivity.this);
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(ReturnListActivity.this, 1);
