...
public class RequestPermissionHandler {
    ...
    public void requestPermission(Context activity, @NonNull String[] permissions, int requestCode,
    ...
    private void requestUnGrantedPermissions(String[] permissions, int requestCode) {
        ...
        ActivityCompat.requestPermissions((Activity) mActivity, unGrantedPermissions, requestCode);
    }
