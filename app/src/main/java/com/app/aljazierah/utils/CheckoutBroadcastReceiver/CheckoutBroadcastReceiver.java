package com.app.aljazierah.utils.CheckoutBroadcastReceiver;
...
public class CheckoutBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (CheckoutActivity.ACTION_ON_BEFORE_SUBMIT.equals(action)) {
            ...
            //You can use this callback to request a new checkout ID if selected payment brand requires some specific parameters or just send back the same checkout id to continue checkout process
